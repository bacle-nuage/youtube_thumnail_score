module Conv:
    ...
    def prop(u, W, b, padding=0, strides=1):
        # パディング
        padding_h, padding_w = getParam(padding)

        # ストライド
        strides_h, strides_w = getParam(strides)
    ...
    function backprop(dz, u, W, b, padding=0, strides=1):
        # 勾配格納領域確保
